...
namespace SatelittiBpms.Data.Migrations
{
    ...
    [Migration("20220318135601_Add_OriginActivityId_SignerIntegrationActivityAuthorizer_And_SignerIntegrationActivitySignatory")]
    partial class Add_OriginActivityId_SignerIntegrationActivityAuthorizer_And_SignerIntegrationActivitySignatory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SatelittiBpms.Models.Infos.SignerIntegrationActivityAuthorizerInfo", b =>
                {
                    ...
                    b.Property<int?>("OriginActivityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SatelittiBpms.Models.Infos.TaskSignerFileInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("FieldValueFileId")
                        .HasColumnType("int");

                    b.Property<int>("SignerId")
                        .HasColumnType("int");

                    b.Property<int>("TaskSignerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FieldValueFileId")
                        .IsUnique();

                    b.HasIndex("TaskSignerId");

                    b.ToTable("TaskSignerFiles");
                });

            modelBuilder.Entity("SatelittiBpms.Models.Infos.TaskSignerInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<DateTime>("DateSendEvelope")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("SatelittiBpms.Models.Infos.SignerIntegrationActivityAuthorizerInfo", b =>
                {
                    ...
                    b.HasOne("SatelittiBpms.Models.Infos.ActivityInfo", "OriginActivity")
                        .WithMany("SignerIntegrationActivityAuthorizerOrigin")
                        .HasForeignKey("OriginActivityId");
            ...
            modelBuilder.Entity("SatelittiBpms.Models.Infos.SignerIntegrationActivitySignatoryInfo", b =>
                {
                    ...
                    b.HasOne("SatelittiBpms.Models.Infos.ActivityInfo", "OriginActivity")
                        .WithMany("SignerIntegrationActivitySignatoryOrigin")
                        .HasForeignKey("OriginActivityId");
            ...
            modelBuilder.Entity("SatelittiBpms.Models.Infos.TaskSignerFileInfo", b =>
                {
                    b.HasOne("SatelittiBpms.Models.Infos.FieldValueFileInfo", "FieldValueFile")
                        .WithOne("TaskSignerFile")
                        .HasForeignKey("SatelittiBpms.Models.Infos.TaskSignerFileInfo", "FieldValueFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SatelittiBpms.Models.Infos.TaskSignerInfo", "TaskSigner")
                        .WithMany("Files")
                        .HasForeignKey("TaskSignerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FieldValueFile");

                    b.Navigation("TaskSigner");
                });
            ...
            modelBuilder.Entity("SatelittiBpms.Models.Infos.TaskSignerInfo", b =>
                {
                    b.HasOne("SatelittiBpms.Models.Infos.TaskInfo", "Task")
                        .WithOne("TaskSigner")
                        .HasForeignKey("SatelittiBpms.Models.Infos.TaskSignerInfo", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SatelittiBpms.Models.Infos.ActivityInfo", b =>
                {
                    ...
                    b.Navigation("SignerIntegrationActivityAuthorizerOrigin");

                    b.Navigation("SignerIntegrationActivitySignatoryOrigin");
